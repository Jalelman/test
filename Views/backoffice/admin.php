...
if(!isset( $_SESSION['mail'], $_SESSION['name'],$_SESSION['role'] )){
	...
	// calcule nombre de user
	$nombre = Count($userdata);
        echo $nombre;


	//calcule nombre de customer
	$query = $pdo->query('SELECT * FROM user WHERE (role = 0)');
	$userdata2 = $query->fetchall();
	$nombre_customer = Count($userdata2);

	//calcule nombre de admin
	$query2 = $pdo->query('SELECT * FROM user WHERE (role = 1)');
	$userdata3 = $query2->fetchall();
	$nombre_admin = Count($userdata3);
	
	//calcule nombre de livreur
	$query3 = $pdo->query('SELECT * FROM user WHERE (role = 2)');
	$userdata4 = $query3->fetchall();
	$nombre_livreur = Count($userdata4);	
?>
            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="../adem/DeliveryMan/Views/AddDeliveryman.php">Add delivary man</a></li>
                            <li><a  href="../adem/DeliveryMan/Views/listdeliveryman.php" aria-expanded="false">List delivery man</a>
                                <!-- <ul aria-expanded="false">
							...
							<li><a href="../adem/Area/Views/addarea.php">Add Area</a></li>
							<li><a href="../adem/Area/Views/listarea.php">List Area</a></li>
							
							<li><a href="../adem/test/Views/index.php">List Delivery</a></li>
							<li><a href="../adem/test/Views/available.php">Available Delivery</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="../adem/Stats/Views/">Delivery</a></li>
							<li><a href="../nadhir/views/Back/offer_percentage.php">Offers</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="../nadhir/views/Back/ListOffer.php">List of Offers</a></li>
                            <li><a href="../nadhir/views/Back/List_type_Offer.php">Offer types</a></li>
                            <!-- <li><a href="./ui-badge.html">Offer</a></li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="../aziz_amine/Bonsai/Views/Back/ListOrders.php">Liste Of Orders</a></li>
							<li><a href="../aziz_amine/Bonsai/Views/Back/OrderStats.php"> Order State</a></li>
                        </ul>
                    </li>
                    <li><a  href="javascript:void()" class="has-arrow ai-icon" aria-expanded="false">
						...
						<ul aria-expanded="false">
                            <li><a href="../aziz_amine/Bonsai/Views/Back/affichermenu.php">Liste Of Menu</a></li>
                            <li><a href="../aziz_amine/Bonsai/Views/Back/Statistic.php">Menu stats</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="../aziz_amine/Bonsai/Views/Back/afficherproduct.php">List Of Products</a></li>
                            <li><a href="../aziz_amine/Bonsai/Views/Back/statistiqueprod.php">Products Stats</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="../nouha/bonsaiB/Views/ListReservation.php">List Of Reservation</a></li>
                    
							<li><a href="../nouha/bonsaiB/Views/statsReservation.php">Statistics Reservations</a></li>
                            <li><a href="../nouha/bonsaiB/Views/statsTable.php">Statistics Tables</a></li>
							<li><a href="../nouha/bonsaiB/Views/ListTable.php">list of Tables </a></li>
							<li><a href="../nouha/bonsaiB/Views/addTable.php">add Table</a></li>
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						...
						<p class="mb-0">Welcome to Bonsai Admin!</p>
					</div>
						...
						<div class="widget-stat card">
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ml-0"><?php echo $nombre_livreur; ?></span></h3>
										<p class="mb-0">Total Delivary</p>
						...
						<div class="widget-stat card">
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ml-0"><?php echo $nombre_admin; ?></span></h3>
						...
						<div class="widget-stat card">
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ml-0"><?php echo $nombre_customer; ?></span></h3>
						...
						<div class="widget-stat card">
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ml-0"><?php echo $nombre; ?></span></h3>
