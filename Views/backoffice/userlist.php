											...
											<tr>
                                                    ...
                                                    for($i = 0; $i < $nb_data; $i++)
                                                    {
                                                       ...
                                                       if($userdata[$i]['status']==0){
                                                        echo " <td> <a href='status_change.php?varid=". $userdata[$i]['idUser']."'><button  style='border:0px;'><span class='badge light badge-danger' id='status_badge'>Blocked</span></button></a></td>";
                                                     }
                                                     if($userdata[$i]['status']==1){
                                                        echo " <td> <a href='status_change.php?varid=". $userdata[$i]['idUser']."'><button  style='border:0px;'><span class='badge light badge-success' id='status_badge'>Open</span></button></a></td>";
                                                     }
